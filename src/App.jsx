...
function App() {
  return (
    <div>
      ...
      <div className="text-white bg-gradient-to-b from-[#2b22a9] to-[#0b1437] to-[#7d66ce] hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-5 py-2.5">
        <Testimonials />
      </div>
